...
class ItemTest {
	...
	void setUp() throws Exception  {
		...
		itemDTO=new ItemDTO(true, itemDescription);
		itemToRegister=new ItemRegistrationDTO(itemRetrieval, itemDTO);
	...
	void testUpdateDifferentQuantity() {
		...
		itemToRegisterDifferent=new ItemRegistrationDTO(itemRetrievalDifferent, itemDTO);
